...
export const sampleData = [
  {
    ...
    description:
      "Miracle Messages Map is a web application built to connect homeless people to their families. I was the back-end enginner on the process and I implemented a RESTful API designed using NodeJS with a PostgreSQL database.",
    image: MMM,
